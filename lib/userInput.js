...
module.exports = {
  getInput: async () => {
    ...
    console.log(
      chalk.yellow(figlet.textSync("Deploy QB", { horizontalLayout: "full" }))
    );
    ...
    const questions = [
      ...
      },
      {
        ...
        type: "text",
        message:
          "Enter the repository ID - or a unique numeric value for this project:",
        validate: function (value) {
          if (value.length) {
            return true;
          } else {
      ...
      },
      {
        ...
        type: "text",
        message:
          '(Optional) Enter a custom prefix to be used for UAT deployments.  If left blank a "D_" will be added to filenames for UAT deployments.',
      },
      {
    ...
    const questions = [
      {
        ...
        type: "input",
        message:
          "Enter the Quick Base application DBID or hit enter to accept the default shown:",
      ...
      },
      {
        ...
        type: "input",
        message:
          "Enter the Quick Base realm or hit enter to accept the default shown:",
      ...
      },
      {
        ...
        message:
          "Enter the repository ID - or a unique numeric value for this project or hit enter to accept the default shown:",
        validate: function (value) {
          if (value.length) {
            return true;
          } else {
      ...
      },
      {
        ...
        message:
          '(Optional) Enter a custom prefix to be used for UAT deployments or hit enter to accept the default shown.  If a blank value is entered, "D_" will be added to filenames for UAT deployments.',
      },
      {
        name: "customPrefixProduction",
        type: "text",
